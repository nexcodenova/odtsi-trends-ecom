...
export function Navbar({ categories }: { categories: Category[] }) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-primary shadow-sm">
      {/* Row 1 — mobile: logo, account. Desktop: full bar with search + currency
          + icons. Always visible. The hamburger drawer that used to live here
          is gone — the bottom bar now covers Home/Categories/Wishlist/Cart/
          Wallet, row 2 below already carries the same shop quick-links and
