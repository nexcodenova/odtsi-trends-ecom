...
export function OnSaleHero({ maxDiscountPct, dealCount }: { maxDiscountPct: number; dealCount: number }) {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0B1B4D] via-[#16234F] to-[#C99200] px-6 py-5 sm:px-8 sm:py-7 lg:py-10">
