          ...
          {status === "submitted" ? (
            ...
            <form onSubmit={handleSubmit} className="mx-auto mt-6 flex max-w-lg flex-col gap-3 sm:flex-row">
              <input
                ...
                className="h-12 flex-1 rounded-xl border-2 border-black/10 bg-white px-5 text-sm text-[#16161A] shadow-sm outline-none placeholder:text-[#a3a19c] focus:border-action"
              />
              <button
                type="submit"
                className="flex h-12 w-full flex-shrink-0 items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-[#F6C935] to-[#C99200] px-8 text-sm font-extrabold text-[#16161A] shadow-[0_6px_16px_-6px_rgba(201,146,0,0.55)] transition hover:brightness-105 sm:w-auto"
              >
                <Mail size={15} />
                Subscribe
              </button>
